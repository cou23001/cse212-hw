public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: The first element to dequeue is in 0 index not 1
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: The FIFO needs to add elements in the front and move the rest. It should be Add instead of Insert at the front
